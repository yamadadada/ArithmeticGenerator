...
public class QuestionUtilTest {
    ...
    public void questionsToString() {
        ...
        Number n4 = new Number(4, NumberTypeEnum.FRACTION.getCode(), 5, 4, 26);
        Operator o1 = new Operator(1, OperatorEnum.PLUS.getOperator());
        Operator o2 = new Operator(2, OperatorEnum.DIVISION.getOperator());
        Operator o3 = new Operator(3, OperatorEnum.PLUS.getOperator());
        Parentheses p1 = new Parentheses(2, 3);
        Parentheses p2 = new Parentheses(2, 4);
